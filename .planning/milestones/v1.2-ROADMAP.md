---
title: v1.2 Progression System Roadmap
type: roadmap
tags: [v1.2, shipped, progression]
status: shipped
...
### Phase 19: Multi-Color Pieces

**Goal**: Implement multi-color pieces for Mixer Band
**Depends on**: Phase 17
**Plans**: 3 plans

Plans:
- [x] 19-01: Multi-color piece data structure
- [x] 19-02: Piece rendering with split colors
- [x] 19-03: Ghost piece and O-piece rotation fixes

**Details:**
- Pieces can have different colors per cell
- Ghost piece shows fill preview with colors
- O piece rotates colors (not shape) for split-color pieces

### Phase 20: Expanding Cracks Overhaul

**Goal**: Rework crack system with connected structures and organic growth
**Depends on**: Phase 18
**Plans**: 1 plan

Plans:
- [x] 20-01: Complete crack system overhaul (CrackCell data structure, spreading, merging)

**Details:**
- Cracks are connected structures (not individual cells)
- Same-color cracks merge when touching
- Per-cell growth timers (3-5s random)
- 8-direction spreading
- Leaf cell penalty (50%) causes clustering
- 17 new tests for crack system
